...
<div class="myown">
 <ul class="nav nav-tabs" role="tablist">
  ...
  <li class=""><a href="index.php"><?=$languagetranslate->localizeit('home')?></a></li>
